...
import com.example.demooauth2.security.oauth2.model.OAuth2UserInfoFactory;
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        if (userOptional.isPresent()) {
            ...
            if (!user.getAuthProvider().equals(AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().getRegistrationId()))) {
                throw new OAuth2AuthenticationException("Looks like you're signed up with " + user.getAuthProvider() +
